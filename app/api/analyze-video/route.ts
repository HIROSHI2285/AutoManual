...
※ 全ての操作に結果確認ステップは不要です。以下のような**画面が大きく変わる操作のみ**に結果確認ステップを追加してください：
- ページ遷移・画面切り替え
- ダイアログ・モーダルの表示
- 大きなレイアウト変更・新しいパネルの展開
- 作業の最終結果

**【抽出粒度】**
- 画面上で起こる**主要な操作と重要な画面変化**をステップとして抽出してください。
- 目安として、動画の**5〜10秒に1ステップ**程度の密度が適切です。
- 同じ操作の繰り返しは1つのステップに統合してください。
- 迷ったら抽出する方を選んでください。
